...
#ifndef BancoDM_UnitH
#define BancoDM_UnitH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TBanco_DataModule : public TDataModule
{
__published:	// IDE-managed Components
        TSQLQuery *QTipoConta_SQLQuery;
        TDataSetProvider *QTipoConta_DataSetProvider;
        TClientDataSet *QTipoConta_ClientDataSet;
        TIntegerField *QTipoConta_SQLQueryCODIGO;
        TStringField *QTipoConta_SQLQueryTIPO;
        TStringField *QTipoConta_SQLQuerySITUACAO;
        TIntegerField *QTipoConta_ClientDataSetCODIGO;
        TStringField *QTipoConta_ClientDataSetTIPO;
        TStringField *QTipoConta_ClientDataSetSITUACAO;
        TDataSource *QTipoConta_DataSource;
        TSQLQuery *QMoeda_SQLQuery;
        TDataSetProvider *QMoeda_DataSetProvider;
        TClientDataSet *QMoeda_ClientDataSet;
        TDataSource *QMoeda_DataSource;
        TIntegerField *QMoeda_SQLQueryCODIGO;
        TStringField *QMoeda_SQLQueryNOME;
        TIntegerField *QMoeda_ClientDataSetCODIGO;
        TStringField *QMoeda_ClientDataSetNOME;
        TDataSource *QPessoa_DataSource;
        TSQLQuery *QPessoa_SQLQuery;
        TClientDataSet *QPessoa_ClientDataSet;
        TDataSetProvider *QPessoa_DataSetProvider;
        TIntegerField *QPessoa_SQLQueryID;
        TStringField *QPessoa_SQLQueryPRIMEIRO_NOME;
        TStringField *QPessoa_SQLQuerySOBRENOME;
        TStringField *QPessoa_SQLQueryAPELIDO;
        TSQLTimeStampField *QPessoa_SQLQueryNASCIMENTO;
        TStringField *QPessoa_SQLQuerySEXO;
        TStringField *QPessoa_SQLQueryCARGO;
        TFloatField *QPessoa_SQLQuerySALARIO;
        TStringField *QPessoa_SQLQueryMOEDA;
        TIntegerField *QPessoa_SQLQueryDIA_PAGTO;
        TStringField *QPessoa_SQLQueryEMAIL;
        TIntegerField *QPessoa_ClientDataSetID;
        TStringField *QPessoa_ClientDataSetPRIMEIRO_NOME;
        TStringField *QPessoa_ClientDataSetSOBRENOME;
        TStringField *QPessoa_ClientDataSetAPELIDO;
        TSQLTimeStampField *QPessoa_ClientDataSetNASCIMENTO;
        TStringField *QPessoa_ClientDataSetSEXO;
        TStringField *QPessoa_ClientDataSetCARGO;
        TFloatField *QPessoa_ClientDataSetSALARIO;
        TStringField *QPessoa_ClientDataSetMOEDA;
        TIntegerField *QPessoa_ClientDataSetDIA_PAGTO;
        TStringField *QPessoa_ClientDataSetEMAIL;
        TStringField *QPessoa_ClientDataSetDIA_STRING;
        TStringField *QPessoa_ClientDataSetSEXO_STRING;
        TDataSource *QTelefone_DataSource;
        TSQLQuery *QTelefone_SQLQuery;
        TDataSetProvider *QTelefone_DataSetProvider;
        TClientDataSet *QTelefone_ClientDataSet;
        TIntegerField *QTelefone_SQLQueryDDD;
        TStringField *QTelefone_SQLQueryTELEFONE;
        TIntegerField *QTelefone_ClientDataSetDDD;
        TStringField *QTelefone_ClientDataSetTELEFONE;
        TStringField *QTelefone_ClientDataSetTELEFONE_STR;
        TSQLQuery *QEndereco_SQLQuery;
        TDataSetProvider *QEndereco_DataSetProvider;
        TClientDataSet *QEndereco_ClientDataSet;
        TDataSource *QEndereco_DataSource;
        TIntegerField *QEndereco_SQLQueryID;
        TStringField *QEndereco_SQLQueryTIPO;
        TStringField *QEndereco_SQLQuerySIGLATIPO;
        TStringField *QEndereco_SQLQueryENDERECO;
        TIntegerField *QEndereco_SQLQueryNUMERO;
        TStringField *QEndereco_SQLQueryBAIRRO;
        TStringField *QEndereco_SQLQueryCIDADE;
        TStringField *QEndereco_SQLQueryESTADO;
        TStringField *QEndereco_SQLQuerySIGLAESTADO;
        TStringField *QEndereco_SQLQueryCEP;
        TStringField *QEndereco_SQLQueryPAIS;
        TIntegerField *QEndereco_ClientDataSetID;
        TStringField *QEndereco_ClientDataSetTIPO;
        TStringField *QEndereco_ClientDataSetSIGLATIPO;
        TStringField *QEndereco_ClientDataSetENDERECO;
        TIntegerField *QEndereco_ClientDataSetNUMERO;
        TStringField *QEndereco_ClientDataSetBAIRRO;
        TStringField *QEndereco_ClientDataSetCIDADE;
        TStringField *QEndereco_ClientDataSetESTADO;
        TStringField *QEndereco_ClientDataSetSIGLAESTADO;
        TStringField *QEndereco_ClientDataSetCEP;
        TStringField *QEndereco_ClientDataSetPAIS;
        TStringField *QEndereco_ClientDataSetENDERECO_STRING;
        TStringField *QEndereco_ClientDataSetESTADO_STRING;
        TStringField *QPessoa_ClientDataSetNOMECOMPLETO;
        TSQLQuery *QBanco_SQLQuery;
        TDataSetProvider *QBanco_DataSetProvider;
        TClientDataSet *QBanco_ClientDataSet;
        TDataSource *QBanco_DataSource;
        TIntegerField *QBanco_SQLQueryCODIGO;
        TStringField *QBanco_SQLQueryNOME;
        TIntegerField *QBanco_ClientDataSetCODIGO;
        TStringField *QBanco_ClientDataSetNOME;
        TSQLQuery *ContasDivididas_SQLQuery;
        TDataSetProvider *ContasDivididas_DataSetProvider;
        TClientDataSet *ContasDivididas_ClientDataSet;
        TDataSource *ContasDivididas_DataSource;
        TIntegerField *ContasDivididas_SQLQueryID;
        TIntegerField *ContasDivididas_SQLQueryCODIGO;
        TFloatField *ContasDivididas_SQLQueryVALOR;
        TStringField *ContasDivididas_SQLQueryMOEDA;
        TSQLTimeStampField *ContasDivididas_SQLQueryVENCIMENTO;
        TStringField *ContasDivididas_SQLQueryTIPOCONTA;
        TIntegerField *ContasDivididas_SQLQuerySITUACAO;
        TStringField *ContasDivididas_SQLQueryDESCRICAO;
        TStringField *ContasDivididas_SQLQueryCREDITO;
        TIntegerField *ContasDivididas_ClientDataSetID;
        TIntegerField *ContasDivididas_ClientDataSetCODIGO;
        TFloatField *ContasDivididas_ClientDataSetVALOR;
        TStringField *ContasDivididas_ClientDataSetMOEDA;
        TSQLTimeStampField *ContasDivididas_ClientDataSetVENCIMENTO;
        TIntegerField *ContasDivididas_ClientDataSetSITUACAO;
        TStringField *ContasDivididas_ClientDataSetDESCRICAO;
        TStringField *ContasDivididas_ClientDataSetCREDITO;
        TStringField *ContasDivididas_ClientDataSetCREDITOSTRING;
        TStringField *ContasDivididas_ClientDataSetPAGO;
        TStringField *ContasDivididas_ClientDataSetTIPOCONTA;
        ...
        TDataSource *Conta_DataSource;
        TIntegerField *TipoConta_SQLTableCATEGORIA;
        TIntegerField *TipoConta_ClientDataSetCATEGORIA;
        void __fastcall QPessoa_ClientDataSetCalcFields(TDataSet *DataSet);
        void __fastcall QTelefone_ClientDataSetCalcFields(
          TDataSet *DataSet);
        void __fastcall QEndereco_ClientDataSetCalcFields(
          TDataSet *DataSet);
        void __fastcall ContasDivididas_ClientDataSetCalcFields(TDataSet *DataSet);
private:	// User declarations
public:		// User declarations
        __fastcall TBanco_DataModule(TComponent* Owner);
        bool ChecarLoginUser(AnsiString Login, AnsiString Senha);
        bool ChecarLoginAdmin(AnsiString Login, AnsiString Senha);
        void PrepararContasDados(int ID, int Mes, int Ano);
        TDateTime SetarParametrosProc(void);
        void ExcluirConta(int ID, int Codigo);
        void AtualizarConta(void);
        void AtualizarStatusConta(int ID, int Conta, int NovoStatus);
        void AtivarQueriesApoio(void);
        void AtualizarDadosPessoais(int ID);
        void AtualizarContasDivididas(int Ano, int Mes, int ID, int Tipo);
        bool AdicionarTipoConta(AnsiString Nome, AnsiString Descricao, AnsiString Situacao);
        void AtualizarTipoConta(void);
        void AtualizarMoeda(void);
        void AtualizarPessoa(int ID);
        void AtualizarTelefone(int ID);
        void AtualizarEndereco(int ID);
        bool ExisteTipoConta(AnsiString Nome);
};
//---------------------------------------------------------------------------
extern PACKAGE TBanco_DataModule *Banco_DataModule;
//---------------------------------------------------------------------------
#endif
